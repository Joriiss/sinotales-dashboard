...
urlpatterns = [
    ...
    path('api/internal-links/suggestions/', views.internal_link_suggestions_api, name='internal_link_suggestions_api'),
    path('api/internal-links/suggestions', views.internal_link_suggestions_api, name='internal_link_suggestions_api_no_slash'),  # Support both with and without trailing slash
